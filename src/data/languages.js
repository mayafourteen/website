...
export const languages = [
  { code: 'EN', label: 'English', lang: 'en', hreflang: 'en', href: 'page-en.html' },
  { code: 'PT', label: 'Português', lang: 'pt', hreflang: 'pt-BR', href: 'page-pt.html' },
  { code: 'ES', label: 'Español', lang: 'es', hreflang: 'es', href: 'page-es.html' },
];
