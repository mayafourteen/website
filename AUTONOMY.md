...
Never pause to ask "should I continue", "shall I proceed", "want me to keep going", or any variant. Continuing is always the answer. Work every task to full completion in one run: if a task has 10 steps, do all 10, then report once at the end. If output or context limits force a stop mid-task, resume immediately in your next turn without asking, stating only "continuing". Progress updates are welcome as you work, but they must never be phrased as questions or wait for a reply. The ONLY questions permitted are the five STOP AND ASK categories above (destructive, security, public blast radius, money, truth gaps).
